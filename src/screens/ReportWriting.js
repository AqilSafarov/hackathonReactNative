  ...
  return (
    <View style={styles.container}>
      <View style={styles.section}>
        <Text style={{ fontSize: 22, fontWeight: 'bold' }}>Report Cybersecurity Incident</Text>
      </View> 
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            >
              ...
              <Picker.Item label="Infection with malware (Trojan, ransomware, worm, etc.)" value="Infection with malware (Trojan, ransomware, worm, etc.)" />
              <Picker.Item label="Phishing" value="Phishing" />
              <Picker.Item label="DoS/DDoS" value="DoS/DDoS" />
              <Picker.Item label="Hacked social network account" value="Hacked social network account" />
              <Picker.Item label="Fake social network account" value="Fake social network account" />
              <Picker.Item label="Cyberfraud" value="Cyberfraud" />
              <Picker.Item label="Web defacement" value="Web defacement" />
              <Picker.Item label="Network intrusion" value="Network intrusion" />
              <Picker.Item label="Data stealing" value="Data stealing" />
              <Picker.Item label="Suspicious e-mail attachment and link" value="Suspicious e-mail attachment and link" />
